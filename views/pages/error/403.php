<div class="content">
    ...
    <!-- <div class="box"> -->
        ...
        <div class="msg"> <?= LANG['NO_ACCESS_INFO'] ?? "Vous avez été bani du site car vous avez tentez une certaine action détecter par le serveur" ?>  </div>

        <!-- <a href="<?= LINK['MAIN'] ?? "" ?>"> Réessayer </a> -->
